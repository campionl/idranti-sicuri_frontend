...
function loadPins(map) {
    ...
    jsonData.forEach((item, i) => {
        ...
        if (geolocPerm) {
            popup += `<a href="https://www.google.com/maps?saddr=${geoloc[0]},${geoloc[1]}&daddr=${item.location_lat},${item.location_lon}"><button class="btn-primary" id="button_info_pin">Apri in Maps</button></a>`;
        } else {
