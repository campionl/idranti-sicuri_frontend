...
<script>
// Pagina Dettagli: visualizza le informazioni di un idrante dato l'`id` in route.
// - Recupera i dati da `this.$store.state.map.pins` usando la prop `id`.
// - Fornisce un form per cambiare direttamente l'ID visualizzato.
export default {
    data() {
        return {
            input: '',
